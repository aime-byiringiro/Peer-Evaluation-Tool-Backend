...
public class InstructorControllerTest {
    ...
    void testFindInstructorByIdSuccess() throws Exception {
        ...
        instructor.setId(132);
        instructor.setFirstName("John");
        instructor.setLastName("Doe");
        given(this.instructorService.findById(132)).willReturn(instructor);
    ...
    @Test
    void testFindInstructorByFirstName() throws Exception {
        // Given
        given(this.instructorService.searchInstructors("John", null, null, null, true))
                .willReturn(Arrays.asList(this.instructors.get(0), this.instructors.get(2)));

        // When and Then
        this.mockMvc.perform(get("/instructors/search?firstName=John").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
